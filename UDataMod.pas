...
begin
  ...
  if v < 4 then
    ExecSQL('ALTER TABLE VENDA ADD DESCONTO NUMERIC(15,4) DEFAULT 0;', True);
  ExecSQL('UPDATE VERSAO SET ID = 4;', True);
end;
...
procedure TDm.CDSVendaCalcFields(DataSet: TDataSet);
begin
  CDSVendaSUBTOTAL.AsFloat := CDSVendaTOTALVENDIDO.AsFloat - CDSVendaDESCONTO.AsFloat;
end;
