...
uses UPadrao, UDataMod, UThreadExecSql, UFiltroData, UProduto;
...
function GetEstoque(AIdProduto: Integer): Double;
begin
  Result := StrToFloatDef(VarToStr(ExecSQL('SELECT ESTOQUE FROM PRODUTOS WHERE ID = ' + IntToStr(AIdProduto))),0);
end;
